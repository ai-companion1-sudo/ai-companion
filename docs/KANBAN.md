# Kanban-Board – Aufgabenliste des Projekts

Wird bei jedem Arbeitsschritt aktualisiert. Reihenfolge innerhalb einer Spalte = ungefähre Priorität.

## Backlog (spätere Ideen, noch nicht konkret geplant)
- Swipe-Bildschirm zum Entdecken/Hinzufügen von Companions (siehe backlog/BACKLOG.md)
- Mehrere Companion-Profile (Aussehen, Kultur, Charakter, Geo-Position)
- Übersicht mehrerer aktiver Chats
- Sprache/Anruf-Funktion
- Avatar (visuelle Darstellung)
- Adult-Inhalte (nur mit aktivem Alters-Gate)
- Login/Auth-Flow (ausgebaut)
- Bezahlung
...
- PROJEKT_LOG.md angelegt
- backlog/BACKLOG.md angelegt
